...
const PaymentMethodChart = () => {
        ...
        datasets: [
            {
                ...
                data: data.map(d => d.payment_method_count),
    ...
    const barChartoptions = {
        ...
        plugins: {
            legend: { position: "top" },
            title: { display: true, text: "Biểu Đồ Số Lượt Theo Phương Thức Thanh Toán" },
            datalabels: {
                anchor: 'end',
                align: 'top',
                offset: 4,
    ...
    const pieChartoptions = {
        ...
        plugins: {
            ...
            title: { display: true, text: '% Số Lượt Theo Phương Thức Thanh Toán' },
            datalabels: {
