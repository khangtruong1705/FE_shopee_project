        ...
        <div className='w-75 mx-auto pt-5 '>
            <div className='card' style={{ backgroundColor: '#ffffff' }}>
                <div className='card-body d-flex '>
                    ...
                    <div className={styles.item}><strong>Sản Phẩm</strong></div>
                    <div className={styles.item}><strong>Đơn Giá</strong></div>
                    <div className={styles.item}><strong>Số Lượng</strong></div>
                    <div className={styles.item}><strong>Số Tiền</strong></div>
                    <div className={styles.item}><strong>Thao Tác</strong></div>
                </div>
            </div>
            <div>
