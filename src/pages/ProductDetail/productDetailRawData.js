...
export const productInfoDetail = [
    { label: "Danh mục", value: "Trị sẹo, mờ vết thâm" },
    { label: "Quy cách", value: "Tuýp x 25g" },
    { label: "Dạng bào chế", value: "Dạng kem" },
    { label: "Xuất xứ thương hiệu", value: "Việt Nam" },
    {
        label: "Mô tả ngắn",
        value:
            "Kem Dizigone Nano bạc là kem bôi kháng khuẩn, tái tạo da và ngăn ngừa sẹo...",
    },
    {
        label: "Nhà sản xuất",
        value: "CÔNG TY TNHH TERRAPHARM VIỆT NAM",
    },
